...
async function run() {
    ...
    console.log("[1] Creating Token Core...");
    ...
    try {
        ...
        console.log("[2] Minting & Distributing...");
        ...
        console.log(`\n=================================================`);
        console.log(`$NNG IS LIVE AND AUTONOMOUS (EMERGENCY MODE)`);
        console.log(`MINT: ${mint.toBase58()}`);
        console.log(`EXPLORER: https://explorer.solana.com/address/${mint.toBase58()}?cluster=custom&customUrl=https://devnet-rpc.solayer.org`);
        console.log(`=================================================\n`);
    } catch (e) {
